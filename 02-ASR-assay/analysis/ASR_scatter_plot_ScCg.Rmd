...
asr_dot %>% filter(Strain == "Cg") %>% 
  ggplot(aes(x = H2O2_con, y = ASR_score)) + geom_point(dotsize = 2, alpha = 0.5) +   theme_bw() +
  theme(axis.text.x=element_text(hjust=1)) +
  ylab("ASR Score (r'/r)") +
  xlab("H2O2 conc. (mM)")
...
asr_dot %>%
  ggplot(aes(x = H2O2_con, y = ASR_score)) + geom_point(aes(color = Strain),dotsize = 2, alpha = 0.5) +   theme_bw() +
  theme(axis.text.x=element_text(hjust=1)) +
  ylab("ASR Score (r'/r)") +
  xlab("H2O2 conc. (mM)")
