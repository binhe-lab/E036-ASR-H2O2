...
Subtract the rich media background from the treated samples
```{r}
treat_colors <- c( "#9900FF", viridis::viridis(5, begin = 0.3, end = 0.9, direction = -1))
treat_levels <- c("-Pi", paste(c(50, 62.5, 100, 125, 150), "Rapa", sep = "_"))
names(treat_colors) <- treat_levels                       
data %>%
