...
p.rna <- filter(rna.ddCt, Target == "CTA1_A") %>% 
  ...
  stat_summary(aes(group = Strain), fun = "mean", geom = "crossbar", color = "red",
...
## Cta1 induction dynamics under -Pi and H<sub>2</sub>O<sub>2</sub>
Used in Figure 3B.
...
names(genotype_color) <- c("WT", "msn4-", "msn2-","skn7-", "yap1-", "msn4- skn7-")
...
ggsave("output/20221108-trans-deletion-timecourse.png", width = 4.5, height = 4)
```
