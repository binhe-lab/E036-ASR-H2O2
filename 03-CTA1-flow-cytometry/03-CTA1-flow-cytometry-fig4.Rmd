...
## Cta1 induction dynamics under -Pi and H2O2
Used in Figure 3B.
### Prepare data
```{r}
...
pi.dat.long %>%
  ...
  scale_color_manual(values= treat_color, labels = c(bquote("2mM "~H[2]~O[2]), "-Pi", "Control")) +
  theme(legend.text = element_text(size = rel(0.85), face = 1), legend.position="top", legend.title = element_blank())
