...
myPlotExn <- function(dat, col = c("S. cerevisiae" = "gray30", "C. glabrata" = "orange2"),
                      fill = c("S. cerevisiae" = "gray80", "C. glabrata" = "gray20"),
                      font_size = 16, legend = TRUE, grid = FALSE)
{
  ...
  geoms <- list(
    ...
    theme(legend.title = element_blank(),
          legend.text = element_text(size = rel(1), face = 3), 
...
p.obj <- list(
  myPlotExn(dat$antioxidant, legend = TRUE) + scale_y_continuous(limits = c(-1, NA)),
  myPlotExn(dat$`protein degradation`, legend = FALSE) + scale_y_continuous(limits = c(-.5, NA)),
  myPlotExn(dat$chaperon, legend = FALSE) + theme(axis.title = element_blank()) + scale_y_continuous(limits = c(-1.5, NA)),
  myPlotExn(dat$TF, legend = FALSE) + theme(axis.title = element_blank())
)
...
ggsave("../output/20221102-HBZ-compare-gene-exn-multipanel.png")
```
